...
INPUT_PATH = os.path.join(BASE, "docs/agent/reports/synthesis-input/filtered-tax-korea-v2.json")
OUTPUT_PATH = os.path.join(BASE, "docs/agent/reports/synthesis-input/tax-korea-tfidf-v2.json")
