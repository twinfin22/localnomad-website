...
INPUT_PATH = os.path.join(BASE, "docs/agent/reports/synthesis-input/filtered-bundle-korea.json")
OUTPUT_PATH = os.path.join(BASE, "docs/agent/reports/synthesis-input/bundle-korea-tfidf.json")
