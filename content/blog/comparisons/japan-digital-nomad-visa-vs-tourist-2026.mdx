...
You don't qualify for the DN visa (income too low, no exceptions, no waivers). Use the tourist visa: enter for 90 days, then extend locally to 180 days via immigration bureau. Important caveat: the 180-day extension is only available to nationals of [7 specific countries](https://www.mofa.go.jp/j_info/visit/visa/short/novisa.html) (Austria, Germany, Ireland, Liechtenstein, Mexico, Switzerland, and UK) per MOFA bilateral agreements. Everyone else is capped at 90 days. You'll be in the gray zone, but that's the trade-off when the DN visa's income bar is out of reach.
