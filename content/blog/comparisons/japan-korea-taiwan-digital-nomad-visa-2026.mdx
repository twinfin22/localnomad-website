...
Taiwan again. Gold Card spouses can apply to the Ministry of Labor (MOL) for an open work permit — no employer sponsorship needed, but it's not automatic. Korea allows dependents on F-1-D but spouses can't work freely. Japan handles family case-by-case with separate applications.
