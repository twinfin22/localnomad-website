...
<ResponsiveTable
  ...
  rows={[
    ...
    ["Income requirement", "₩88M/yr (~$64K) — GNI×2 ([source](https://www.immigration.go.kr/bbs/immigration_eng/229/464290/download.do))", "¥10M/yr (~$68K) — [source](https://www.moj.go.jp/isa/content/001422249.pdf)", "No income floor — portfolio-based (11 fields)"],
...
Korea ties the threshold to 2× GNI (Gross National Income) per capita [as announced by the Bank of Korea](https://www.immigration.go.kr/bbs/immigration_eng/229/464290/download.do). Based on 2024 GNI of ₩44,051,000, that's currently ~₩88 million. The USD equivalent depends on the exchange rate on your application date — roughly $64,000–66,000 at recent rates. Updated each April. You submit 3–6 months of bank statements showing consistent deposits, or a work contract from a registered company.
...
Taiwan doesn't set a salary minimum. Instead, you must fit one of [11 professional fields](https://goldcard.nat.gov.tw/en/qualification/) including Digital, Science & Technology, Finance, Economy, Culture and Arts, Architecture, and more — as defined by Taiwan's National Development Council. Proof is portfolio-based: GitHub repos, published work, certifications, degrees, client letters.

[goldcard.nat.gov.tw/en/qualification](https://goldcard.nat.gov.tw/en/qualification/)

Korea and Japan have similar income bars. Korea is more flexible on proof format. Taiwan has no income floor, but you must fit a specific professional category. If your work is niche and doesn't map cleanly into those 11 fields, Korea or Japan is your route.
