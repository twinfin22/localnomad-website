...
A regular apartment lease in Japan requires a resident registration certificate called juminhyo (住民票). You only get that after living in the country for 90+ days. Until then, most landlords and guarantor companies (hoshou gaisha / 保証会社) reject your application outright. No juminhyo, no guarantor, no lease.
