...
**Tax withholding:** approximately 6.75% is withheld from the lump-sum. This may be reduced under an applicable tax treaty between Korea and your home country.
...
Call the number on your monthly bill and notify them of your departure date. Confirm you won't re-enter within 30 days.
...
If you expect a refund or have unresolved tax matters, appoint a 납세관리인 (tax representative) under the Framework Act on National Taxes Article 82. This person handles post-departure NTS inquiries on your behalf, including receiving refunds.
...
Withdraw your funds but keep the account open. The account becomes inactive after a period of no transactions. After roughly 5 years of inactivity, banks may close the account without authorization. Online banking certificates typically need annual renewal, which may require Korean authentication.
...
Yes, but with limitations. You cannot close it remotely. Banking apps often fail from abroad due to Korean phone verification. The account becomes dormant after extended inactivity. If you plan to return within 1-2 years, keeping it open (with passport linkage) is usually the better option.
