---
title: "China Arrival Checklist for Nomads 2026"
...
**Register WeChat and Alipay with your international phone number.** Link a Visa or Mastercard. Complete identity verification. These two apps run daily life in China: paying for street food, hailing taxis, ordering delivery, even unlocking shared bikes. Foreign card support for both apps is governed by [People's Bank of China regulations](https://www.pbc.gov.cn) and has expanded significantly since 2023 — but limits and supported card types change, so verify current rules before you travel. Without them you're stuck using cash, and plenty of small vendors don't accept it anymore.
...
**Start your visa research.** China has no digital nomad visa. Most remote workers enter on an [M visa (business) or L visa (tourist)](https://www.nia.gov.cn) — typically 30 days per entry for the L. If you're employed by a Chinese company, that's a Z visa (work permit). Each type has different invitation letter requirements and processing times of 1-2 weeks through your nearest Chinese embassy. [China Ultimate Guide](/en/blog/guides/china-ultimate-digital-nomad-guide) covers the full breakdown.
...
<Callout type="info">Hotels register your stay with police automatically ([required for all foreigners within 24 hours](https://en.nia.gov.cn)). Staying at an Airbnb or apartment? You must register at the local police station (派出所, pàichūsuǒ) yourself within 24 hours. Your host should help with this.</Callout>
