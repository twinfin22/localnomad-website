---
title: "Korea's ARC → Phone → Bank Loop, and How to Break It"
...
Your ARC (외국인등록증, Alien Registration Card) is the key that opens everything else. Book your immigration appointment early, as waits run 1–2 weeks in Seoul.
...
**Hana Bank's "Hana the EASY" program** is built for foreigners: 16-language support, Sunday branches in areas with large foreign populations (Ansan, Gimhae, Cheonan). If there's one near you, start there.
