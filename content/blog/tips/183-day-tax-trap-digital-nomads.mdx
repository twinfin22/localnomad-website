...
**2026 update: the consecutive-day rule.** Starting in 2026, 183 consecutive days spanning two calendar years also trigger residency. Previously, the count reset on January 1 each year. A nomad who arrived on July 5 could stay until December 31 (180 days), leave for a week, return on January 8, and the new-year reset meant neither calendar year crossed 183. That loophole is closed. If 183 unbroken days stretch across December into January, you are a tax resident for the year in which the threshold is crossed. Plan your departures accordingly and do not rely on the new-year reset.

> *Note: This rule change is based on the amended Income Tax Act as reported in early 2026. Verify the current text with a licensed Korean tax professional (세무사) before making any stay decisions.*
