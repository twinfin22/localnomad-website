...
Japan's DN visa comes with non-resident status built in. Foreign-source income? Zero tax to Japan. Stay 180 days earning from US clients? You owe Japan nothing.
...
Taiwan's DTT network is thin: only 35 treaties (vs Korea's 97, Japan's 80+). EU countries, Australia, and New Zealand are missing. A Brazilian freelancer earning Taiwan-source income on a Gold Card can end up taxed in both countries with no treaty relief. Check your country's status before moving.
...
<ResponsiveTable
  ...
  rows={[
    ...
    ["Over-threshold rate", "6–45% progressive + 3.3% local", "20.42% on Japan-source income only", "5–40% graduated on Taiwan-source"],
    ...
    ["DTT network size", "97 treaties", "80+ treaties", "35 treaties"],
