        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Curated guides, checklists, and playbooks to make your Korea journey smooth
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {bundles.map((bundle, index) => (
              ...
              >
                ...
                <div className="text-3xl font-bold text-primary mb-6">{bundle.price}</div>
          ...
          <div className="mt-16 text-center p-8 bg-secondary rounded-2xl">
            ...
            <p className="text-muted-foreground mb-4">Get all three guides at a discounted price</p>
            <div className="text-4xl font-bold text-primary mb-6">
              $69 <span className="text-lg text-muted-foreground line-through">$87</span>
            </div>
