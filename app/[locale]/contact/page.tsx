  ...
  return (
    <main id="main-content" className="min-h-svh bg-background">
      <article className="mx-auto max-w-3xl px-6 py-24">
        ...
        <h1 className="mt-8 font-lora text-4xl font-bold">Contact Us</h1>
        ...
        <div className="mt-12 space-y-8 leading-relaxed text-muted-foreground">
          <p>
            ...
            about our platform, or just want to connect — here&apos;s how to reach us.
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 rounded-lg border p-5">
              ...
              <div>
                <h2 className="font-semibold text-foreground">Discord Community</h2>
                <p className="mt-1 text-sm">
                  The best place for visa questions, tips, and connecting with other
                  nomads in Asia.
                </p>
                <a
            ...
            <div className="flex items-start gap-4 rounded-lg border p-5">
              ...
              <div>
                ...
                <p className="mt-1 text-sm">
                  Follow us for nomad life updates and community highlights.
                </p>
                <a
          ...
          <div className="rounded-lg bg-muted/50 px-5 py-4">
            <p className="text-sm">
              For visa-specific questions, please consult a licensed immigration
              professional in your destination country. LocalNomad provides general
              information only and cannot offer personalized legal advice.
            </p>
          </div>
        </div>
      </article>
