...
export const alt = 'LocalNomad Visa Comparison';
...
async function getBgSrc(country: string): Promise<string | null> {
  try {
    // SEA uses its own hero image (jpg for Satori compat); East Asia countries use neighborhood thumb
    const filePath = country === 'southeast-asia'
      ? join(process.cwd(), 'public', 'images', 'sea-hero-bg.jpg')
      : join(process.cwd(), 'public', 'images', 'neighborhoods', `${country}-thumb.jpg`);
